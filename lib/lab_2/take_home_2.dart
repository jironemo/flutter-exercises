import 'package:demo_app/lab_2/booking_info.dart';
...
void main() {
  runApp(MaterialApp(
    ...
    initialRoute: '/home',
    routes: {
      '/home': (context) => const TicketBooking(),
      '/info': (context) => const BookingInfoPage()
    },
  ));
}
                    ...
                    onPressed: () {
                      setState(() {
                        if (_formKey.currentState!.validate()) {
                          ...
                          Navigator.pushNamed(
                              context, '/info', arguments: Ticket(
                              city: selectedLocation,
                              cname: _nameController.text,
                              date: _dateController.text,
                              phno: _phoneController.text,
                              price: priceByLocation[selectedLocation]
                          ));
